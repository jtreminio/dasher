...
const allKeys = (data: ObjString_ObjString) => {
    const names: string[] = [];

    for (const g of Object.keys(data)) {
        names.push(...Object.keys(data[g]));
    }
...
const fpm: IniI = {
    data: {
        "": {
            ...
            "FPM.listen": "0.0.0.0:9000",
            "FPM.listen.backlog": "511",
            "FPM.listen.mode": "0660",
            "FPM.pid": "/var/run/php-fpm/php-fpm.pid",
            "FPM.pm": "dynamic",
...
const xdebug: IniI = {
    ...
    all: () => allKeys(xdebug.data),
};

const mods73: ModuleI = {
    default: [
        "bcmath",
        "cli",
        "curl",
...
const modules: { [key: string]: ModuleI } = {
    "v7.3": mods73,
    "v7.2": mods72,
    "v7.1": mods71,
    "v7.0": mods70,
